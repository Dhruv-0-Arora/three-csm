import { ShaderChunk, Group, BufferGeometry, BufferAttribute, LineSegments, LineBasicMaterial, Box3Helper, Box3, Color, MeshBasicMaterial, DoubleSide, Mesh, PlaneGeometry, Matrix4, Vector3, Object3D, DirectionalLight, Vector2, MathUtils } from 'three';
...
class CSM {
    constructor(data) {
        ...
        this.lightDirection = (_j = data.lightDirection) !== null && _j !== void 0 ? _j : new Vector3(1, -1, 1).normalize();
        this.lightDirectionUp = (_k = data.lightDirectionUp) !== null && _k !== void 0 ? _k : Object3D.DEFAULT_UP;
